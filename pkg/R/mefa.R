...
## xtab.fixed=TRUE, xtab sor/oszlop nevei fixek, ha F akkor a legsz<U+0171>kebb halmazt adja eredm<U+00E9>ny<U+00FC>l
    xtab2 <- xtab
    if (!is.null(samp)) {
...
## segm list subsetting xtab2 alapj<U+00E1>n
