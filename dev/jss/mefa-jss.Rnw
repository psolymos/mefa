...
\begin{figure}[tb]
    \includegraphics[width=1\textwidth]{mefa-jss-mefastr}
...
\begin{figure}[tb]
    \includegraphics[width=1\textwidth]{mefa-jss-plot}
...
\begin{figure}[tb]
    \includegraphics[width=1\textwidth]{mefa-jss-boxplot}
...
\begin{figure}[tb]
    \includegraphics[width=1\textwidth]{mefa-jss-image}
...
\begin{figure}[tb]
    \includegraphics[width=1\textwidth]{mefa-jss-clust}
